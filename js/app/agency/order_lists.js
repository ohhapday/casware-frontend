...
requirejs([
    ...
    let Order_lists = (function () {
        ...
        let Order_lists = function (options) {
            this.myTable = null;
            this.data = null;
    ...
    let order_lists = new Order_lists(options[0]);
});
